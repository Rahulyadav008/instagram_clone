...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void signUpUser() async {
    ...
    if(_image!=null){
      ...
      if (res == "success") {
        setState(() {
          print("resultttt id --------${res}");
          _isLoading = false;
        });
        // navigate to the home screen
        Navigator.of(context).pushReplacement(MaterialPageRoute(
          builder: (context) => ResponsiveLayout(mobileScreenLayout: MobileScreenLayout(), webScreenLayout: WebScreenLayout(),
          ),
        ),);
      } else {
        print("resultttt id --------${res}");
      ...
      showSnackBar('Please choose profile image', context);
      _isLoading=false;
    }
  }
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              InkWell(
                child: Container(
                  child:
                  !_isLoading ? const Text('Sign up',) : const CircularProgressIndicator(color: primaryColor,),
                  width: double.infinity,
